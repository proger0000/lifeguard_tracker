...
if (!$post_id) {
    ...
    smart_redirect('index.php', [], 'admin-posts-content'); // Перенаправлення назад до списку постів
    exit();
}
        ...
        if (empty($errors)) {
            try {
                ...
                if ($stmt_update->execute()) {
                    ...
                    smart_redirect('index.php', [], 'admin-posts-content'); // Повернення до адмін-панелі, вкладка постів
                    exit();
                } else {
