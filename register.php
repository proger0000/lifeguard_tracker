...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !validate_csrf_token($_POST['csrf_token'])) {
        ...
        if (empty($errors) && empty($error_message)) {
            ...
            $default_role = $input['role']; // Явно вказуємо роль для INSERT
...
<div class="flex items-center justify-center min-h-screen text-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 glass-effect p-8 sm:p-10">
        <div>
        ...
        <form class="mt-8 space-y-6" action="register.php" method="POST" novalidate>
            ...
            <div class="mb-4">
                 <label for="full_name" class="block text-gray-200 text-sm font-bold mb-2">ПІБ (Прізвище Ім'я По батькові)</label>
            ...
            <div class="mb-4">
             ...
             <div class="mb-4">
                 <label for="password" class="block text-gray-200 text-sm font-bold mb-2">Пароль</label>
            ...
            <div class="mb-6"> <label for="confirm_password" class="block text-gray-200 text-sm font-bold mb-2">Підтвердіть Пароль</label>
            ...
            <div>
                 <button type="submit" class="w-full flex justify-center btn">
                     Зареєструватися
                 </button>
            </div>
