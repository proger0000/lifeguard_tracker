...
<div class="container mx-auto px-4 py-8 max-w-2xl"> <!-- Обмежено ширину -->
    <h2 class="text-2xl font-bold text-white mb-6">Ваш Профіль</h2>

    <!-- === Секція Інформації Профілю (Додано/Оновлено) === -->
    <div class="glass-effect p-6 mb-8">
        <h3 class="text-lg font-semibold text-gray-200 border-b border-gray-200 pb-3 mb-4">Інформація</h3>
        <dl class="space-y-2"> <!-- Використання списку визначень для кращої семантики -->
            <div class="flex flex-col sm:flex-row sm:items-center">
                <dt class="sm:w-1/4 font-semibold text-gray-300">ПІБ:</dt>
                <dd class="text-gray-100 mt-1 sm:mt-0 sm:w-3/4"><?php echo escape($user_full_name); ?></dd>
            </div>
             <div class="flex flex-col sm:flex-row sm:items-center">
                <dt class="sm:w-1/4 font-semibold text-gray-300">Email:</dt>
                <dd class="text-gray-100 mt-1 sm:mt-0 sm:w-3/4"><?php echo escape($user_email); ?></dd>
             </div>
             <div class="flex flex-col sm:flex-row sm:items-center">
                 <dt class="sm:w-1/4 font-semibold text-gray-300">Роль:</dt>
                <dd class="text-gray-100 mt-1 sm:mt-0 sm:w-3/4"><?php echo escape($user_role_ukrainian); ?></dd>
            </div>
        </dl>
    </div>
    <!-- ================================================ -->
    ...
    <div class="glass-effect p-6">
        <h3 class="text-lg font-semibold text-gray-200 border-b border-gray-200 pb-3 mb-4">Зміна Пароля</h3>
        ...
        <form action="profile.php" method="POST" class="space-y-4" novalidate>
            ...
            <input type="hidden" name="change_password" value="1">
             ...
             <div>
                <label for="current_password" class="block text-sm font-medium text-gray-200 mb-1">Поточний пароль</label>
            ...
            <div>
                <label for="new_password" class="block text-sm font-medium text-gray-200 mb-1">Новий пароль (мін. 6 символів)</label>
            ...
            <div>
                <label for="confirm_new_password" class="block text-sm font-medium text-gray-200 mb-1">Підтвердіть новий пароль</label>
