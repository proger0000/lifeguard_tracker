...
if (!$user_id) {
    ...
    header('Location: ../index.php#admin-users-content'); // Перенаправлення назад до списку
    exit();
}
        ...
        if (empty($errors)) {
            try {
                ...
                if ($stmt_update->execute($params)) {
                    ...
                    header('Location: ../index.php#admin-users-content'); // Повернення до списку користувачів
                    exit();
                } else {
